...
class Student extends Admin_Controller {
    ...
    function create() {
        ...
        $data['categorylist'] = $category;
        //
        $status_course = $this->category_model->getStatus();
        $data['statuscourselist'] = $status_course;
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                //số lượng buổi học
                'number_lesson' => $this->input->post('number_lesson'),
                //
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'weight' => $this->input->post('weight'),
                'note' => $this->input->post('note'),
                'reserve_reason' => $this->input->post('reserve_reason'),
                'reserve_day' => $this->input->post('reserve_day'),
                'measurement_date' => date('Y-m-d', $this->customlib->datetostrtotime($this->input->post('measure_date')))
            );
