        ...
        <div class="row">
            ...
            <div class="box box-info" style="padding:5px;">
                ...
                <div class="box-body table-responsive">
                    <div class="download_label"><?php echo $this->lang->line('login_credential'); ?> <?php echo $this->lang->line('report'); ?></div>
                    <table class="table table-striped table-bordered table-hover example">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('username'); ?> <?php echo $this->lang->line('parent'); ?></th>
                                <th><?php echo $this->lang->line('password'); ?> <?php echo $this->lang->line('parent'); ?></th>
