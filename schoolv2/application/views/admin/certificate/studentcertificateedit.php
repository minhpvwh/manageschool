            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('student'); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('student'); ?></div>
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('name'); ?> <?php echo $this->lang->line('certificate'); ?></th>
