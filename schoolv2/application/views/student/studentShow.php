  ...
  <?php 
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                            ...
                            <div class="tshadow mb25 bozero">   
                                <h3 class="pagetitleh2"><?php echo $this->lang->line('category'); ?> <?php echo $this->lang->line('detail'); ?></h3>
                                <div class="table-responsive around10 pt0">  
                                    <table class="table table-hover table-striped tmb0"><tbody>
                                            <tr>
                                                <td><?php echo $this->lang->line('category'); ?></td>
                                            ...
                                            <tr>
                                                <td><?php echo $this->lang->line('number_lesson'); ?></td>
                                                <td><?php if($student['execute']=="Bảo Lưu"){ ?>
                                                                    <p style="color: #FF0000;">Đang bảo lưu: <?php echo $student['number_lesson'] ?> </p>
                                                    <?php }else{ if($student['number_lesson']==0){?>
                                                                
                                                                    <p style="color: #4CAF50;"><?php echo $this->lang->line('complete'); ?></p>
                                                    <?php }else{ ?>
                                                                    <?php echo $student['number_lesson'] ?>
                                                    <?php }} ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('cast'); ?></td>
                                            ...
                                            <tr>
                                                <td><?php echo $this->lang->line('reserve_reason'); ?></td>
                                                <td><?php echo $student['reserve_reason']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('reserve_day'); ?></td>
                                                <td><?php echo $student['reserve_day']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
