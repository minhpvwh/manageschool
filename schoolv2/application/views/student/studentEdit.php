                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select  id="cast" name="cast" class="form-control" >
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php
                                                    foreach ($statuscourselist as $category) {
                                                        ?>
                                                        <option value="<?php echo $category['status'] ?>" <?php if ($student['cast'] == $category['status']) echo "selected =selected" ?>><?php echo $category['status']; ?></option>
                                                        <?php
                                                        $count++;
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                         ...
                                         <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('reserve_reason'); ?></label>
                                                           <?php


                                                            ?>
                                                           <input type="text" value="<?php echo $student["reserve_reason"] ?>" name="reserve_reason" class="form-control" value="<?php echo set_value('reserve_reason', $student['reserve_reason']); ?>">
                                                            <span class="text-danger"><?php echo form_error('reserve_reason'); ?></span>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('reserve_day'); ?></label>                       

 <input id="reserve_day" name="reserve_day" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('reserve_day', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['reserve_day']))); ?>" readonly="readonly"/>
                                                            <span class="text-danger"><?php echo form_error('reserve_day'); ?></span>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#dob,#admission_date,#measure_date,#reserve_day').datepicker({
            format: date_format,
            autoclose: true
        });
