                                ...
                                <div class="around10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  id="cast" name="cast" class="form-control" >
                                                    ...
                                                    foreach ($statuscourselist as $category) {
                                                        ?>
                                                        <option value="<?php echo $category['status'] ?>" <?php if (set_value('cast') == $category['status']) echo "selected=selected"; ?>><?php echo $category['status'] ?></option>
                                                        <?php
                                                        $count++;
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('number_lesson'); ?></label>
                                                           <?php


                                                            ?>
                                                           <input type="text" name="number_lesson" class="form-control" placeholder="Số lượng buổi học" value="<?php echo set_value('number_lesson'); ?>">
                                                            <span class="text-danger"><?php echo form_error('number_lesson'); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="exampleInputFile"><?php echo $this->lang->line('photo'); ?> <?php echo $this->lang->line('student'); ?> </label>
