                                ...
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('number_lesson') ?></th>
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if($student['cast']==$this->lang->line('reserve')){ ?>
                                                                    <p style="color: #FF0000;"><?php echo $this->lang->line('reserve'); ?>: <?php echo $student['number_lesson'] ?> </p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-6 col-md-6">
                                                            <address>
                                                                ...
                                                                <b><?php echo $this->lang->line('number_lesson'); ?>: </b>
                                                                <?php if($student['cast']==$this->lang->line('reserve')){ ?>
                                                                    <p style="color: #FF0000;"><?php echo $this->lang->line('reserve'); ?>: <?php echo $student['number_lesson'] ?> </p>
